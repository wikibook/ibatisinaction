begin
  execute immediate 'drop sequence linenum';
exception
  when others then null;
end;

begin
  execute immediate 'drop sequence ordernum';
exception
  when others then null;
end;

begin
  execute immediate 'drop index productCat';
exception
  when others then null;
end;

begin
  execute immediate 'drop index productName';
exception
  when others then null;
end;

begin
  execute immediate 'drop index itemProd';
exception
  when others then null;
end;
...
begin
  execute immediate 'drop table bannerdata';
exception
  when others then null;
end;
